			...
			<div className="SearchGroup">
				<div className="SearchBar">
					<div className="BarGroup">
						<label htmlFor="SearchField">Introducir Nombre</label>
				...
				<div className="Selectors">
					<div className="SelectorBody">
						<label htmlFor="ThemeSelector">Temática:</label>
					...
					<div className="SelectorBody">
						<label htmlFor="MemberSelector">Miembros:</label>
						<select className="GenericSelector" id="MemberSelector">
							<option value={true}>Buscando</option>
							<option value={false}>Cerrado</option>
						</select>
					</div>

					<div className="SelectorBody">
						<label htmlFor="SortingSelector">Ordenar por:</label>
					...
					<div className="SelectorBody">
						<label htmlFor="DonationSelector">Acepta Donaciones:</label>
